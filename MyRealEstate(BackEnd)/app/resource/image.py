    ...
    def get(cls, user_id: int):
        ...
        for filename in filenames:
            ...
            try:
                ...
                images_data.append({"filename": filename, "image_path": image_path})
...
class AvatarUpload(Resource):
    ...
    def put(cls):
        ...
        # Check if an avatar already exists for the user and delete it
...
class AdminAvatarUpload(Resource):
    @classmethod
    @jwt_required()  # Require authentication for this endpoint
    def put(cls):
        # Get the user ID of the currently logged-in user
...
class AdminAvatar(Resource):
    ...
    def get(cls, admin_id: int):
        ...
        return {"message": gettext("admin_avatar_not_found")}, 404
